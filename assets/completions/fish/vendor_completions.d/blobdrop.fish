...
complete -c blobdrop -s '-f' -l 'frontend' -d 'selects frontend' -x -a "auto\t'automatic' gui\t'show window' immediate\t'drag immediately' notify\t'drag from notification' link\t'print OSC8 link'"
complete -c blobdrop -s '-i' -l 'immediate' -d 'drag immediately'
